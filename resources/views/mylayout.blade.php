                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="javascript:void(0);">
                        <i class="bx bx-power-off bx-md me-3"></i><span></span>
                      </a>
                    </li>
                  </ul>
                </li>
              ...
              <div class="container-xxl">
                <div
                  ...
                  <div class="d-none d-lg-inline-block">
                    <a href="https://github.com/Driannm" class="footer-link me-4" target="_blank">GitHub</a>
                    <a href="https://www.linkedin.com/in/yuda-andrian/" target="_blank" class="footer-link me-4">LinkedIn</a>
                    <a href="https://www.behance.net/driannjaegar" target="_blank" class="footer-link me-4">Behance</a>
                    <a href="https://dribbble.com/Driann_" target="_blank" class="footer-link">Dribble</a>
                  </div>
                </div>
              </div>
            </footer>
