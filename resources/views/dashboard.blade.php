    ...
    <div class="col-xxl-8 mb-6 order-0">
      <div class="card">
        <div class="d-flex align-items-start row">
          <div class="col-sm-7">
            <div class="card-body">
              <h5 class="card-title text-primary mb-3">Congratulations Yuda! 🎉</h5>
              <p class="mb-6">
            ...
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between mb-4">
                <div class="avatar flex-shrink-0">
                  <img
                    src="../assets/img/icons/unicons/total-pasien.png"
                    alt="chart success"
                    class="rounded" />
                </div>
                <div class="dropdown">
              ...
              <h4 class="card-title mb-3">3405</h4>
              <small class="text-success fw-medium"><i class="bx bx-up-arrow-alt"></i>443 Pasien</small>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 col-6 mb-6">
          <div class="card h-100">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between mb-4">
                <div class="avatar flex-shrink-0">
                  <img
                    src="../assets/img/icons/unicons/pasien-baru.png"
                    alt="wallet info"
                    class="rounded" />
                </div>
                <div class="dropdown">
              ...
              <p class="mb-1">Pasien Baru</p>
              <h4 class="card-title mb-3">679</h4>
              <small class="text-success fw-medium"><i class="bx bx-up-arrow-alt"></i>24 Pasien</small>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-6 mb-6">
          <div class="card h-100">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between mb-4">
                <div class="avatar flex-shrink-0">
                  <img src="../assets/img/icons/unicons/obat.png" alt="paypal" class="rounded" />
                </div>
                <div class="dropdown">
                  <button
                    class="btn p-0"
        ...
        <div class="col-6 mb-6">
          <div class="card h-100">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between mb-4">
                <div class="avatar flex-shrink-0">
                  <img src="../assets/img/icons/unicons/pasien-sembuh.png" alt="Credit Card" class="rounded" />
                </div>
                <div class="dropdown">
                  <button
                    class="btn p-0"
